...
### product_types
Типы продукции — для группировки в прайслистах.
- `id` — первичный ключ
- `name` UNIQUE — название типа (Чёрный чай, Зелёный чай, Улун, и т.д.)
- `sort_order` — порядок сортировки при выгрузке
...
- `type_id` — ссылка на product_types (тип для группировки в прайслисте)
